        ...
        buttons: [
          {
            ...
            buttonParamsJson: JSON.stringify({
              ...
              url: config.social?.youtube || 'http://youtube.com/@kobby_blurr-w6f'
            })
          },
          {
            name: 'cta_url',
            buttonParamsJson: JSON.stringify({
              ...
              url: config.social?.github || 'https://github.com/K-blurr'
            })
          },
          {
            name: 'cta_url',
            buttonParamsJson: JSON.stringify({
              ...
              url: 'https://whatsapp.com/channel/0029Vb5m6YmEKyZOWf0LXl39'
            })
          }
        ]
      }, { quoted: msg });
