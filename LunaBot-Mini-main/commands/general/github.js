...
module.exports = {
    ...
    async execute(sock, msg, args, extra) {
        try {
            ...
            const repoUrl = 'https://github.com/K-blurr/LunaBot-Mini';
            const apiUrl = 'https://api.github.com/repos/K-blurr/LunaBot-Mini';
            ...
            try {
                ...
                fallbackMessage += `🔗 *Repository:* LunaBot-Mini\n`;
                fallbackMessage += `👨‍💻 *Owner:* kobbyblurr\n`;
