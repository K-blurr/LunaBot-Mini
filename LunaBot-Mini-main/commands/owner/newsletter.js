 ...
 * @param {string} link - Channel link (e.g., https://whatsapp.com/channel/0029Vb5m6YmEKyZOWf0LXl39)
  ...
  async execute(sock, msg, args, extra) {
    try {
      ...
      if (!text || text.trim().length === 0) {
        return extra.reply('❌ Please provide a WhatsApp channel link!\n\nExample: .newsletter https://whatsapp.com/channel/0029Vb5m6YmEKyZOWf0LXl39');
      }
